...
function createAccount(newAccountId, newAccountOwner) {
  if (newAccountId === accounts.id) {
    throw new Error("Account already exists, please choose new ID number");
  }
  accounts.push({
    id: newAccountId,
...
getAccountById("1");  Fixed with a triple equal instead of double equals

createAccount(1, "Alice"); Used new error message along with if statement
